...
// development only
  ...
  //  Q.nbind(adminApi.getPoWStats, adminApi)()
  //    .then(function(stats){
  //      io.sockets.emit('usage', { memory: stats.memory, cpu: stats.cpu });
  //    })
  //    .fail(function(){
  //      // Fail: get stats from local process
  //      return Q.nbind(usage.lookup, usage, process.pid, { keepHistory: true })()
  //        .then(function(stats){
  //          io.sockets.emit('usage', { memory: stats.memory, cpu: stats.cpu });
  //        });
  //    })
