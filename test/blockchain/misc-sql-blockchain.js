...
const MiscIndexedBlockchain = require('../../app/lib/blockchain/miscIndexedBlockchain')
...
describe('MISC SQL Blockchain', () => {
  ...
  before(() => co(function*() {
    ...
    blockchain = new MiscIndexedBlockchain(ArrayBlockchain(), mindexDAL, iindexDAL, sindexDAL, cindexDAL)
  }))
