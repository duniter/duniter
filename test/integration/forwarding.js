...
describe("Forwarding", function() {
  ...
  describe("Nodes", function() {
    ...
    var node1 = node('db_1', _({ httplogs: true, port: 9600, remoteport: 9600, salt: 'abc', passwd: 'abc', routing: true }).extend(common));
    var node2 = node('db_2', _({ httplogs: true, port: 9601, remoteport: 9601, salt: 'abc', passwd: 'def', routing: true }).extend(common));
