  ...
  it('should be able to save a Block', function(){
    return sqliteDAL.saveBlock(mocks.block0)
      ...
      .then(function(blocks){
        ...
        blocks[0].should.have.property('currency').equal(mocks.block0.currency);
        blocks[0].should.have.property('issuer').equal(mocks.block0.issuer);
        blocks[0].should.have.property('parameters').equal(mocks.block0.parameters);
        blocks[0].should.have.property('previousHash').equal(mocks.block0.previousHash);
        blocks[0].should.have.property('previousIssuer').equal(mocks.block0.previousIssuer);
        blocks[0].should.have.property('membersCount').equal(mocks.block0.membersCount);
        blocks[0].should.have.property('monetaryMass').equal(mocks.block0.monetaryMass);
        blocks[0].should.have.property('UDTime').equal(mocks.block0.UDTime);
        blocks[0].should.have.property('medianTime').equal(mocks.block0.medianTime);
        blocks[0].should.have.property('dividend').equal(mocks.block0.dividend);
        blocks[0].should.have.property('time').equal(mocks.block0.time);
        blocks[0].should.have.property('powMin').equal(mocks.block0.powMin);
        blocks[0].should.have.property('number').equal(mocks.block0.number);
