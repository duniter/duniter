    ...
    while (yield continuePromise) {
      try {
        ...
        try {
          ...
          const trial = yield rules.HELPERS.getTrialLevel(version, selfPubkey, server.getBcContext());
          ...
          yield Promise.race([
            ...
            co(function*() {
              try {
                ...
                const trial2 = yield rules.HELPERS.getTrialLevel(block2.version, server.keyPair.publicKey, server.getBcContext());
