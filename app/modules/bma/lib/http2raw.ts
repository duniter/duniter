...
module.exports = {
  identity: requiresParameter(
    "identity",
    BMAConstants.ERRORS.HTTP_PARAM_IDENTITY_REQUIRED
  ),
  certification: requiresParameter(
    "cert",
    BMAConstants.ERRORS.HTTP_PARAM_CERT_REQUIRED
  ),
  revocation: requiresParameter(
    "revocation",
    BMAConstants.ERRORS.HTTP_PARAM_REVOCATION_REQUIRED
  ),
  transaction: requiresParameter(
    "transaction",
    BMAConstants.ERRORS.HTTP_PARAM_TX_REQUIRED
  ),
  peer: requiresParameter("peer", BMAConstants.ERRORS.HTTP_PARAM_PEER_REQUIRED),
  membership: Http2RawMembership,
  block: requiresParameter(
    "block",
    BMAConstants.ERRORS.HTTP_PARAM_BLOCK_REQUIRED
  ),
