...
class Master {
    ...
    initCluster() {
        ...
        this.slaves = Array.from({ length: this.nbCores }).map((value, index) => {
            ...
            this.slavesMap[worker.id] = {
                ...
                nonceBeginning: this.nbCores === 1 ? 0 : (index + 1) * constants_1.Constants.NONCE_RANGE
            };
    ...
    proveByWorkers(stuff) {
        ...
        return (() => __awaiter(this, void 0, void 0, function* () {
            yield Promise.all(this.workersOnline);
            ...
            return yield this.currentPromise;
        }))();
    }
...
//# sourceMappingURL=powCluster.js.map